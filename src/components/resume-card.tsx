...
export const ResumeCard = ({
    ...
    return (
        <a
            ...
            onClick={handleClick}
        >
            <Card className="flex flex-row items-center w-full px-3 bg-card border border-border">
                <Avatar className="border items-center  size-16 m-auto bg-secondary">
                    <AvatarImage
                        src={logoUrl}
                        alt={altText}
                ...
                <div className="flex-1 items-center flex-col group">
                  ...
                  {badges.map((badge, index) => (
                      <Badge
                          variant="secondary"
                          className="align-middle text-nowrap text-sm bg-secondary text-secondary-foreground"
                          key={index}
                      >
                          {badge}
                      </Badge>
