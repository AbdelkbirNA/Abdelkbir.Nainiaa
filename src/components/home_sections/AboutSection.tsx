...
export function AboutSection() {
    ...
    const skillIcons: Record<string, JSX.Element> = {
        ...
        "Next.js": <SiNextdotjs className="text-black dark:text-white" />,        "Tailwind CSS": <SiTailwindcss className="text-sky-400" />,
    ...
    "href": "https://2dkservices.com/",
    "badges": ["React.js", "Node.js", "Express.js", "MySQL", "Docker", "Tailwind CSS", "Prisma", "AI Integration", "DevOps"],
    "location": "Marrakesh, Morocco",
    "title": "Full-Stack Developer",
    "logoUrl": "/2dkservices_logo.jpeg",
    "period": "Jul 2025 - Present",
    "description": "Contributed to the development and improvement of innovative web solutions, including OrnoPlante, an AI-powered plant care platform, using modern web technologies and DevOps practices.",
    "achievements": [
        "Developed frontend and backend features using React.js, Node.js, Express.js, and MySQL",
        "Collaborated with the technical team to deliver high-quality projects",
        "Implemented AI assistant features to handle user queries and plant image recognition",
        "Optimized app performance and responsiveness, enhancing user experience",
        "Deployed and maintained Dockerized services with CI/CD pipelines",
        "Built an admin panel to efficiently manage plant data and user interactions"
    ]
}
    ];
    const slugs = [
    ...
    courses: ["Mathematics", "Physics", "Computer Science Fundamentals", "Programming Basics"]
},
        {
                  ...
                  <span className="flex-shrink-0">
                    ...
                    >
                        <h3 className="text-2xl sm:text-3xl font-bold">
                            I'm <span className="text-primary font-poppins">Abdelkbir Nainiaa</span>
                        </h3>
